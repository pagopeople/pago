...
export default function ReviewEdit() {
    ...
    const [review, setReviewHook] = useState<Review>(reviewsState.activeReview || {version: 0});
    ...
    //                     trueText='Yes'
    //                     falseText='No'
    //                     selected={review?.hadDeadline}
    //                     onSelectedUpdate={(hadDeadline: boolean) => setReview({...review, hadDeadline})}
    //                 >
    //                     <DatePicker 
    ...
    //                     trueText='Yes'
    //                     falseText='No'
    //                     selected={review?.withCoworkers}
    //                     onSelectedUpdate={(withCoworkers: boolean) => setReview({...review, withCoworkers})}
    //                 >
    //                     <select 
    //                         value={review?.coworkerId} 
    //                         onChange={(e: ChangeEvent<HTMLSelectElement>) => setReview({...review, coworkerId: e.currentTarget.value})}>
    ...
    //                     endHint={'Exceptional'}
    //                     options={optionsOneToTen}
    //                     selectedVal={review?.coworkerPerformanceScore}
    //                     onSelectedValChange={(val: string | number) => setReview({...review, coworkerPerformanceScore: val as number})}   
    //                 />
    //             </div>
    //             <div>
    //                 <div>
    ...
    //                 </div>
    //                 <select 
    //                     value={review?.skillsNeeded} 
    //                     onChange={(e: ChangeEvent<HTMLSelectElement>) => setReview({...review, skillsNeeded: e.currentTarget.value})}
    //                 >
    ...
    //                     endHint={'Constantly involved'}
    //                     options={optionsOneToTen}
    //                     selectedVal={review?.skillProficiencyScore}
    //                     onSelectedValChange={(val: string | number) => setReview({...review, skillProficiencyScore: val as number})}  
    //                 />
    //             </div>
    //             <div>
    //                 <div>
    ...
    const getReviewTemplate = () => (
        <>
            <ReviewForm data={review} onUpdate={setReview} readonly={!!reviewId}/>
            {!reviewId && <button className='review-edit-submit-button' onClick={onSubmitReview}>Submit</button>}
        </>
    )
    return(
